...
export default class PermissionsManage extends Component {
    ...
    render() {
        ...
        let breadcrumbData = [
            ...
            { link: '/system/lawyerRole', titleId: 'router.system.lawyer.role.management', title: '专案账号类型管理', query: { goback: true } },
            { link: '', titleId: 'system.role.lawyer.role.editor', title: '权限编辑' },
        ]
        return (
